...
from losses import gen_losses,disc_losses
...
def init_train(path_to_config, train_loader,eval_loader,wandb_set=True,):
    ...
    losses_gen = gen_losses
    losses_disc = disc_losses
...
if __name__ == "__main__":
    ...
    Trainer = init_train(sys.argv[1],train_loader,eval_loader,wandb_set)
    Trainer.train_loop()
