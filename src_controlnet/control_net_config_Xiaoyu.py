...
def parse_args(BATCH_SIZE, input_args=None):
    ...
    parser.add_argument(
        "--has_eval_result_output_to_terminal",
        type=bool,
        default=0,
        help=(
            "Whether or not to output the evaluation results to the terminal. If set to True, the evaluation results will be output to the terminal."
        ),
    )
    parser.add_argument(
        "--controlnet_embedding_merging_mode",
        type=str,
        default="addition",
        help=(
...
def get_args_list(BATCH_SIZE, num_train_epochs, checkpointing_steps, validation_steps):
